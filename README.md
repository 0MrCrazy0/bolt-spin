...
- **1 themed machine Bolt Token Premium** — played with ⚡ tokens only (1–50⚡ stake ladder; not a cash high-roller)
...
- **Auto-spin controls** — limits, stop-loss floor
...
Open `https://0mrcrazy0.github.io/bolt-spin/index.html` in a modern browser.
