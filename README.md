...
| | |
|:--|:--|
| **Cabinets** | **21** regular themed machines + **1** Bolt Token Premium (⚡) |
| **Features** | Hold & Spin · Free Games (retriggers stack) · Express boards · shared Bolt Train pots |
...
3. **Base game** — line wins on the paylines; feature symbols and orbs can trigger bonuses.
