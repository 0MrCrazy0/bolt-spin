...
- **Express boards** — themed 8-cell bonus after Hold & Spin
- **Bolt Train** — rare free Hold & Spin with matching train prizes
- **Bolt Cabinet** — one premium machine played with Bolt tokens (⚡)
...
- **Level ranks** — Rookie → Immortal (by level or machines unlocked)
- **Lifestyle shop** — spend virtual cash on homes, cars, bling & more (cosmetic; small XP on first buy only)
- **Achievements** — 280+ badges with claimable XP (lobby ACH button)
...
├── tone-music.js   # Optional Tone.js machine beds
...
1. Pick a machine from the lobby (Bolt Cabinet sits at the top — costs ⚡).
...
- Progress (balance, level, unlocks, tokens, lifestyle) is saved in **localStorage** on that device/browser
